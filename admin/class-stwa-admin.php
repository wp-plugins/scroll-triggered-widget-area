...
class stwa_Admin {
	...
	private function __construct() {
		$plugin = Scroll_Triggered_Widget_Area::get_instance();
	...
	public function enqueue_admin_styles() {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_style( $this->plugin_slug .'-admin-styles', plugins_url( 'assets/css/admin.css', __FILE__ ), array(), Scroll_Triggered_Widget_Area::VERSION );
		}
	...
	public function enqueue_admin_scripts( $hook_suffix) {
		...
		$screen = get_current_screen();
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_script( $this->plugin_slug . '-admin-script', plugins_url( 'assets/js/admin.js', __FILE__ ), array( 'jquery' ), Scroll_Triggered_Widget_Area::VERSION );
		}
